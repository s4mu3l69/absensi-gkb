                    ...
                    <div class="container-fluid">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td>Waktu</td>
                                                <td><input type="text" class="form-control" value="<?php echo date('l, d-m-Y h:i:s a' ); ?>" name="waktu_masuk" readonly="" ></td>    
                                            </tr>

                                           <tr>
                                           <td>Keterangan</td>
                                            	<td><textarea name="keterangan_masuk" class="form-control" required=""></textarea></td>
                                           </tr>
                                           <tr>
                     ...
                     <div class="row">
                        ...
                        <div class="header-desktop">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2023 PT. Mandiri Perkasa Elektrika All rights reserved. Designer by <a href="">Future Web Design</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
